...
const Config = {
  ...
  GET_TOP_ARTISTS: USER_PROPS.getProperty(`getTopArtists`),
  GET_FOLLOWING: USER_PROPS.getProperty(`getFollowing`),
  GET_ARTISTS_FROM_PLAYLIST: USER_PROPS.getProperty(`getArtistsFromPlaylist`),
  PLAYLIST_ID: USER_PROPS.getProperty(`playlistId`),
  EMAIL: USER_PROPS.getProperty(`email`),
  CREATE_CALENDAR_EVENTS: USER_PROPS.getProperty(`createCalendarEvents`),
